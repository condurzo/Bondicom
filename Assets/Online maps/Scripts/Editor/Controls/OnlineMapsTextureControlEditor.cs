...
//		marker.position.y = EditorGUILayout.FloatField("Latitude: ", (float)OnlineMaps.latitude);
//		marker.position.x = EditorGUILayout.FloatField("Longitude: ", (float)OnlineMaps.longitude);
