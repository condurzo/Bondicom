...
public class OnlineMaps : MonoBehaviour
{
	...
	public static Texture2D FondoText;
	/// <summary>
	...
	private void OnGUI()
	{
		...
		if (showMarkerTooltip == OnlineMapsShowMarkerTooltip.always)
		{
			...
			else //Reemplaza el archivo este de la librería y  por inspector setea en Online Maps ---> Advanced ---> ShowMarkerTooltip --->Always
				//y ya todos te van a aparecer con el label automaticamente.

			{
				...
				foreach (OnlineMapsMarker marker in markers) {
					...
					Vector2 screenPos = control.GetScreenPosition (marker.position);
					Rect rect = new Rect (screenPos.x, screenPos.y, 1, 1);
					/*if (marker.OnDrawTooltip != null) marker.OnDrawTooltip(marker);
                        else if (OnlineMapsMarkerBase.OnMarkerDrawTooltip != null) OnlineMapsMarkerBase.OnMarkerDrawTooltip(marker);
					...
					if (Screen.height == 480) {
						if (rect.xMax > objectPos.x - width * 4 && rect.xMin < objectPos.x + width * 4 && rect.yMax > objectPos.y - height * 4 && rect.y + 30 < objectPos.y + height/2.6f) {
							style.fontSize = 15;
							style.normal.background = FondoText;
							style.normal.textColor = Color.yellow;
							//Debug.Log("UNO "+control.GetScreenPosition(marker.position));
							Vector2 TempA;
							Vector2 TempB;
							//Debug.Log("DOS "+control.GetScreenPosition(marker.position)*2f/1.5f);
							OnGUITooltip (style, marker.label, control.GetScreenPosition (marker.position)*2f/2.3f);

						}
					} 
					if (Screen.height == 800) {
						if (rect.xMax > objectPos.x - width * 4 && rect.xMin < objectPos.x + width * 4 && rect.yMax > objectPos.y - height * 4 && rect.y + 30 < objectPos.y + height/1.7f) {
							style.fontSize = 25;
							style.normal.background = FondoText;
							style.normal.textColor = Color.yellow;
							//Debug.Log("UNO "+control.GetScreenPosition(marker.position));
					...
					if (Screen.height == 854) {
						if (rect.xMax > objectPos.x - width * 4 && rect.xMin < objectPos.x + width * 4 && rect.yMax > objectPos.y - height * 4 && rect.y + 30 < objectPos.y + height/1.55f) {
							style.fontSize = 25;
							style.normal.background = FondoText;
							style.normal.textColor = Color.yellow;
							//Debug.Log("UNO "+control.GetScreenPosition(marker.position));
					...
					if (Screen.height == 960) {
						if (rect.xMax > objectPos.x - width * 4 && rect.xMin < objectPos.x + width * 4 && rect.yMax > objectPos.y - height * 4 && rect.y + 30 < objectPos.y + height/1.45f) {
							style.fontSize = 25;
							style.normal.background = FondoText;
							style.normal.textColor = Color.yellow;
							//Debug.Log("UNO "+control.GetScreenPosition(marker.position));
					...
					if (Screen.height == 1024) {
						if (rect.xMax > objectPos.x - width * 4 && rect.xMin < objectPos.x + width * 4 && rect.yMax > objectPos.y - height * 4 && rect.y + 30 < objectPos.y + height/1.3f) {
							style.fontSize = 30;
							style.normal.background = FondoText;
							style.normal.textColor = Color.yellow;
							//Debug.Log("UNO "+control.GetScreenPosition(marker.position));
					...
					if (Screen.height == 1080) {
						if (rect.xMax > objectPos.x - width * 4 && rect.xMin < objectPos.x + width * 4 && rect.yMax > objectPos.y - height * 4 && rect.y + 30 < objectPos.y + height/1.25f) {
							style.fontSize = 30;
							style.normal.background = FondoText;
							style.normal.textColor = Color.yellow;
							//Debug.Log("UNO "+control.GetScreenPosition(marker.position));
					...
					if (Screen.height == 1136) {
						if (rect.xMax > objectPos.x - width * 4 && rect.xMin < objectPos.x + width * 4 && rect.yMax > objectPos.y - height * 4 && rect.y + 30 < objectPos.y + height/1.2f) {
							style.fontSize = 30;
							style.normal.background = FondoText;
							style.normal.textColor = Color.yellow;
							//Debug.Log("UNO "+control.GetScreenPosition(marker.position));
					...
					if (Screen.height == 1280) {
						if (rect.xMax > objectPos.x - width * 4 && rect.xMin < objectPos.x + width * 4 && rect.yMax > objectPos.y - height * 4 && rect.y + 30 < objectPos.y + height/1.05f) {
							style.fontSize = 40;
							style.normal.background = FondoText;
							style.normal.textColor = Color.yellow;
							//Debug.Log("UNO "+control.GetScreenPosition(marker.position));
					...
					if (Screen.height == 1536) {
						if (rect.xMax > objectPos.x - width * 4 && rect.xMin < objectPos.x + width * 4 && rect.yMax > objectPos.y - height * 4 && rect.y + 30 < objectPos.y + height/0.87f) {
							style.fontSize = 45;
							style.normal.background = FondoText;
							style.normal.textColor = Color.yellow;
							//Debug.Log("UNO "+control.GetScreenPosition(marker.position));
					...
					if (Screen.height == 1920) {
						if (rect.xMax > objectPos.x - width * 4 && rect.xMin < objectPos.x + width * 4 && rect.yMax > objectPos.y - height * 4 && rect.y + 30 < objectPos.y + height/0.7f) {
							style.fontSize = 50;
							style.normal.background = FondoText;
							style.normal.textColor = Color.yellow;
							//Debug.Log("UNO "+control.GetScreenPosition(marker.position));
							Vector2 TempA;
							Vector2 TempB;
							//Debug.Log("DOS "+control.GetScreenPosition(marker.position)*2f/2.3f);
							OnGUITooltip (style, marker.label, control.GetScreenPosition (marker.position)*2f/2.3f);
						}
					} 
					if (Screen.height == 2048) {
						if (rect.xMax > objectPos.x - width * 4 && rect.xMin < objectPos.x + width * 4 && rect.yMax > objectPos.y - height * 4 && rect.y + 30 < objectPos.y + height/0.65f) {
							style.fontSize = 50;
							style.normal.background = FondoText;
							style.normal.textColor = Color.yellow;
							//Debug.Log("UNO "+control.GetScreenPosition(marker.position));
					...
					if (Screen.height >= 2560) {
						if (rect.xMax > objectPos.x - width * 4 && rect.xMin < objectPos.x + width * 4 && rect.yMax > objectPos.y - height * 4 && rect.y + 30 < objectPos.y + height/0.55f) {
							style.fontSize = 55;
							style.normal.background = FondoText;
							style.normal.textColor = Color.yellow;
							//Debug.Log("UNO "+control.GetScreenPosition(marker.position));
